...
public class CMSGCLogParser {
    ...
    public void parse(String logFile) {
        ...
        for (String line : lines) {
            ...
            if (line.contains("[CMS") || line.contains("[GC")) {
                ...
                parseGCRecord(timestamp, line.substring(line.indexOf('[')));
            }
        }
    }

    public void parseGCRecord(String timestamp, String line) {
        // Full GC
        /*
    ...
    public static void main(String[] args) {
        ...
        String outputFile = "src/test/gclogs/ParsedCMSlLog.txt";
