...
def plotHeapUsage(timeOffset, cpuTimeOffset, mode, appName, title, gclogFile, topMetricsFile, outputFile):
    ...
    if (topMetricsFile != ""):
        ...
        axes[2].set_ylim(0, 700)  # The ceil
...
if __name__ == '__main__':
    ...
    cpuTimeOffset = G1TimeOffset
    plotHeapUsage(G1TimeOffset, cpuTimeOffset,
                  mode, appName, "(c) PageRank-0.5-G1-iterative-tasks",
                  inputFile + "G1/G1-E" + str(g1ExecutorID) + "-parsed.txt",
                  inputFile + "G1/topMetrics.txt",
                  inputFile + "G1/G1-E" + str(g1ExecutorID) + ".pdf")
