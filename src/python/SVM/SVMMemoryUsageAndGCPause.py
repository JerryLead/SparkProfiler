...
def plotHeapUsage(mode, appName, title, gclogFile, outputFile):
    ...
    axes[0].set_ylim(0, 7.5)  # The ceil
    axes[1].set_ylim(0, 5)  # The ceil
    ...
    FGCBar = axes[1].bar(fgcTime, fgcPause, 0.01, color=colors2[4], label="Full GC Pause", edgecolor=colors2[4])
